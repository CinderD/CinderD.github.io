          ...
          <Row >
            <Col md={8} xs={12} className="home-header" style={{ flex: '0 0 70%', maxWidth: '70%' }}>
              ...
              <p className="short-bio"  style={{color: '#4f4f4f'}}>I am <strong className="name-highlight">Zixin (Steven) Chen</strong>, a fourth-year PhD candidate at {}
                ...
                <strong className="research-highlight"><span className="nb">human-centered</span> AI systems for education</strong><span className="ref"><a href="https://doi.org/10.1109/TVCG.2026.3695959" title="VizQStudio: Iterative Visualization Literacy MCQs Design with Simulated Students (TVCG 2026)" target="_blank" rel="noreferrer">5</a>,<a href="https://doi.org/10.1109/TVCG.2024.3456363" title="StuGPTViz: A Visual Analytics Approach to Understand Student-ChatGPT Interactions (IEEE VIS 2024)" target="_blank" rel="noreferrer">6</a>,<a href="https://dl.acm.org/doi/10.1145/3746059.3747670" title="CoGrader: Transforming Instructors&rsquo; Assessment of Project Reports through Collaborative LLM Integration (ACM UIST 2025)" target="_blank" rel="noreferrer">7</a>,<a href="https://dl.acm.org/doi/10.1145/3772363.3798931" title="From Passive Consumption to Active Interaction: Exploring Interactive LLM Scaffolding to Support Learning Engagement (ACM CHI EA 2026)" target="_blank" rel="noreferrer">8</a></span> {}
                <strong className="research-highlight">and science</strong><span className="ref"><a href="https://doi.org/10.1109/TVCG.2025.3636102" title="CellScout: Visual Analytics for Mining Biomarkers in Cell State Discovery (TVCG 2025)" target="_blank" rel="noreferrer">9</a>,<a href="https://arxiv.org/abs/2604.23356" title="VeriLLMed: Interactive Visual Debugging of Medical Large Language Models with Knowledge Graphs (IEEE VIS 2026)" target="_blank" rel="noreferrer">10</a>,<a href="https://neurips.cc/virtual/2025/poster/116602" title="PIPE: Physics-Informed Position Encoding for Alignment of Satellite Images and Time Series (NeurIPS 2025)" target="_blank" rel="noreferrer">11</a></span>.
                </p>
                <p className="research-interest"  style={{color: '#4f4f4f'}}>
