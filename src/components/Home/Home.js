          ...
          <Row >
            <Col md={8} xs={12} className="home-header" style={{ flex: '0 0 70%', maxWidth: '70%' }}>
              ...
              <p className="short-bio"  style={{color: '#4f4f4f'}}>I am <strong className="name-highlight">Zixin (Steven) Chen</strong>, a fourth-year PhD candidate at {}
                ...
                <p className="research-interest"  style={{color: '#4f4f4f'}}>
                Recently, I <span className="nb">post-train</span> and evaluate <strong className="research-highlight"><span className="nb">real-world</span> educational agents</strong><span className="ref"><a href="https://chat.qwen.ai/" title="Qwen3.6 &amp; Qwen3.7 — I trained the Learn Mode" target="_blank" rel="noreferrer">1</a>,<a href="https://arxiv.org/abs/2605.14322" title="Are Agents Ready to Teach? A Multi-Stage Benchmark for Real-World Teaching Workflows (EduAgentBench)" target="_blank" rel="noreferrer">2</a></span> {}
                and analyze their <strong className="research-highlight">impact on humans and society</strong>. More broadly, I have extensive experience building {}
                <strong className="research-highlight"><span className="nb">human-centered</span> AI systems for education</strong><span className="ref"><a href="https://doi.org/10.1109/TVCG.2026.3695959" title="VizQStudio: Iterative Visualization Literacy MCQs Design with Simulated Students (TVCG 2026)" target="_blank" rel="noreferrer">3</a>,<a href="https://arxiv.org/abs/2407.12423" title="StuGPTViz: A Visual Analytics Approach to Understand Student-ChatGPT Interactions (IEEE VIS 2024)" target="_blank" rel="noreferrer">4</a>,<a href="https://arxiv.org/abs/2507.20655" title="CoGrader: Transforming Instructors&rsquo; Assessment of Project Reports through Collaborative LLM Integration (ACM UIST 2025)" target="_blank" rel="noreferrer">5</a>,<a href="https://dl.acm.org/doi/10.1145/3772363.3798931" title="From Passive Consumption to Active Interaction: Exploring Interactive LLM Scaffolding to Support Learning Engagement (ACM CHI EA 2026)" target="_blank" rel="noreferrer">6</a></span> {}
                <strong className="research-highlight">and science</strong><span className="ref"><a href="https://doi.org/10.1109/TVCG.2025.3636102" title="CellScout: Visual Analytics for Mining Biomarkers in Cell State Discovery (TVCG 2025)" target="_blank" rel="noreferrer">7</a>,<a href="https://arxiv.org/abs/2604.23356" title="VeriLLMed: Interactive Visual Debugging of Medical Large Language Models with Knowledge Graphs (IEEE VIS 2026)" target="_blank" rel="noreferrer">8</a>,<a href="https://arxiv.org/abs/2506.14786" title="PIPE: Physics-Informed Position Encoding for Alignment of Satellite Images and Time Series (NeurIPS 2025)" target="_blank" rel="noreferrer">9</a></span>.
                </p>
                <p className="research-interest"  style={{color: '#4f4f4f'}}>
